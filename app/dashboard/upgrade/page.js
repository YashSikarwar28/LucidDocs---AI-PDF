//pricing component taken from hyperui
...
function UpgradePlans() {
  ...
  return (
    <div>
      <h2 className="font-bold text-3xl text-center mt-[-30px]">Plans</h2>
      <p className="text-center">Upgrade your plan to upload unlimited files</p>
          ...
          <div className="rounded-2xl border border-gray-200 p-6 shadow-xs sm:px-8 lg:p-12">
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Upto 7 pdf upload </span>
              </li>
