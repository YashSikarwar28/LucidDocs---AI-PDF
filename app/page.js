...
// // ✅ Define outside component so it doesn’t get recreated every render
// const AnimateIfDesktop = ({ children, className, delay = 0, isDesktop, animateOnce }) => {
//   const fadeInUp = {
...
//       variants={fadeInUp}
//       initial="hidden"
//       animate={animateOnce ? "visible" : "hidden"}
...
//   return (
//     <main className="relative flex-1 p-3 lg:p-3 bg-gradient-to-bl from-white to-indigo-800">
//       <div className="relative bg-white py-24 sm:py-30 drop-shadow-xl rounded-md overflow-hidden">
//         {/* ✅ Purple Grid Pattern */}
...
//         {/* 🔹 Hero Section */}
//         <AnimateIfDesktop
//           className="relative flex flex-col justify-center mx-auto items-center max-w-7xl px-6 lg:px-8"
//           delay={0.1}
//           isDesktop={isDesktop}
//           animateOnce={animateOnce}
//         >
//           <div className="mx-auto max-w-2xl">
//             <h2 className="md:text-xl text-center font-semibold text-indigo-600 leading-7 whitespace-nowrap text-[18px]">
//               Turn Static Docs into Lively Conversations
//             </h2>
//             <p className="mt-2 text-2xl text-center font-bold tracking-tight text-gray-800 sm:text-5xl">
//               Discover More, Faster with <br /> AI-Driven PDF Chat
//             </p>
//             <p className="mt-3 text-center text-lg leading-8 text-gray-500">
//               Introducing
//               <span className="text-indigo-600 font-bold"> LucidDocs.</span>
//               <br />
//               Discover, learn, and explore PDFs like never before. Upload any
//               document and ask your questions directly — get fast, accurate
//               answers powered by
//               <br />
...
//             <Button className="mt-8 cursor-pointer bg-indigo-600 hover:bg-indigo-700">
//               Get Started
//             </Button>
//           </SignUpButton>
//         </AnimateIfDesktop>
...
//         {/* 🔹 Image */}
//         <AnimateIfDesktop
//           className="relative flex items-center justify-center px-6 lg:px-8 mt-10"
//           delay={0.2}
//           isDesktop={isDesktop}
//           animateOnce={animateOnce}
//         >
...
//           animateOnce={animateOnce}
//         >
//           <dl className="mx-auto grid grid-cols-1 max-w-2xl gap-x-6 gap-y-10 text-base leading-7 text-gray-700 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
//             {feature.map((f) => (
//               <div className="relative px-8" key={f.name}>
...
//                   animate={animateOnce && isDesktop ? { opacity: 1, y: 0 } : {}}
...
//                     ))}
//                   </div>
//                   <p className="text-gray-600 italic mb-4">“{person.review}”</p>
